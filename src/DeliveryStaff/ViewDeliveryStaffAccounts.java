 ...
 * @author thapa
 */
public class ViewDeliveryStaffAccounts extends javax.swing.JFrame {

    String UID, StoreName;

    /**
     * Creates new form ViewDeliveryStaffAccounts
     */
    public ViewDeliveryStaffAccounts() {
        initComponents();
        StoreTableValue();
    }

    ViewDeliveryStaffAccounts(String UID, String StoreName) {
        this.UID = UID;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDeliveryStaffAccounts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewDeliveryStaffAccounts().setVisible(true);
            }
        });
    }
