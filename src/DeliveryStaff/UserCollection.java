...
public class UserCollection {
    ...
    public UserCollection(String id, String fname, String lname, String Address, String Email, String Password, String Date,String Gender) {
        this.id = id;
        this.fname = fname;
        this.lname = lname;
     ...
     public UserCollection(String data) {
