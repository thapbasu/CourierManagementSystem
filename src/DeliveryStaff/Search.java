...
public class Search extends javax.swing.JFrame {
    ...
    Search(String UID, String StoreName) {
        this.UID = UID;
    ...
    private void Coloring(){
        if(txt_id.getText().equals("Enter an ID to search"))
        {
    ...
    private void initComponents() {
        ...
        txt_id.setForeground(new java.awt.Color(102, 102, 102));
        txt_id.setText("Enter an ID to search");
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(123, 42, 602, 546));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 42, 126, 546));
