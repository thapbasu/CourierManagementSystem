 ...
 * @author thapa
 */
public class DeliverySearchMenu extends javax.swing.JFrame {
    String Name, UID;
    /**
     * Creates new form DeliverySearchMenu
     */
    public DeliverySearchMenu() {
        initComponents();
    }

    DeliverySearchMenu(String UID, String Name) {
        initComponents();
        this.Name = Name;
        this.UID = UID;
   ...
   {   
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(114, 42, 616, 560));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeliverySearchMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeliverySearchMenu().setVisible(true);
            }
        });
    }
