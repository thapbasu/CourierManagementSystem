 ...
 * @author thapa
 */
public class AskSearchDelivery extends javax.swing.JFrame {
    String Name;
    String UID;
    /**
     * Creates new form DeliverySearchMenu
     */
    public AskSearchDelivery() {
        initComponents();
    }

    AskSearchDelivery(String Name,String UID) {
        initComponents();
        this.Name = Name;
        this.UID = UID;
    }
            ...
            try {
                ...
                while ((data = br.readLine()) != null) {
                    ...
                    if (user.getId().equals(search_id)) {
                        ...
                        new DeliverySearchMenu(UID,Name).setVisible(true);
                        return;
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskSearchDelivery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AskSearchDelivery().setVisible(true);
            }
        });
    }
