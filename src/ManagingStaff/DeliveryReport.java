 ...
 * @author thapa
 */
public class DeliveryReport extends javax.swing.JFrame {
    String UID,Name;
    int ds;
    /**
    ...
    public DeliveryReport(String Name, String UID) {
 ...
 public class managereport extends ForReport {
    ...
    private void gettingvalue() {
        ...
        ds = managereport.GetTotalDelivery();
        String totaldeliverystaff = String.valueOf(ds);
        txttotaldelivery.setText(totaldeliverystaff);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 756, -1));
        ...
        jLabel3.setText("Total Delivery:");
        ...
        deliverystaffTable.setBackground(new java.awt.Color(255, 255, 255));
        deliverystaffTable.setForeground(new java.awt.Color(0, 0, 0));
        ...
        deliverystaffTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                deliverystaffTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(deliverystaffTable);
        if (deliverystaffTable.getColumnModel().getColumnCount() > 0) {
            deliverystaffTable.getColumnModel().getColumn(0).setResizable(false);
            deliverystaffTable.getColumnModel().getColumn(0).setPreferredWidth(30);
            deliverystaffTable.getColumnModel().getColumn(1).setResizable(false);
            deliverystaffTable.getColumnModel().getColumn(1).setPreferredWidth(120);
            deliverystaffTable.getColumnModel().getColumn(2).setResizable(false);
            deliverystaffTable.getColumnModel().getColumn(2).setPreferredWidth(120);
            deliverystaffTable.getColumnModel().getColumn(3).setResizable(false);
            deliverystaffTable.getColumnModel().getColumn(3).setPreferredWidth(120);
            deliverystaffTable.getColumnModel().getColumn(4).setResizable(false);
            deliverystaffTable.getColumnModel().getColumn(4).setPreferredWidth(140);
            deliverystaffTable.getColumnModel().getColumn(5).setResizable(false);
            deliverystaffTable.getColumnModel().getColumn(5).setPreferredWidth(130);
            deliverystaffTable.getColumnModel().getColumn(6).setResizable(false);
            deliverystaffTable.getColumnModel().getColumn(6).setPreferredWidth(160);
            deliverystaffTable.getColumnModel().getColumn(7).setResizable(false);
            deliverystaffTable.getColumnModel().getColumn(7).setPreferredWidth(160);
        }
        ...
        descending2.setBackground(new java.awt.Color(255, 255, 255));
        descending2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        descending2.setForeground(new java.awt.Color(25, 118, 211));
        descending2.setText("Descending Order");
        descending2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        ascending2.setBackground(new java.awt.Color(255, 255, 255));
        ascending2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ascending2.setForeground(new java.awt.Color(25, 118, 211));
        ascending2.setText("Ascending Order");
        ascending2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(ascending, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(231, 231, 231)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel12)
                                    .addComponent(descending2)
                                    .addComponent(ascending2, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addContainerGap()
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel9)
                        .addGap(26, 26, 26)
                        .addComponent(ascending, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(descending, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabel12)
                        .addGap(26, 26, 26)
                        .addComponent(ascending2, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(descending2, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(23, Short.MAX_VALUE))
        );

        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(114, 42, 644, 546));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 38, 112, 546));
    ...
    private void ascendingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ascendingActionPerformed
        try {
            ...
            while ((s = raf.readLine()) != null) {
                array = s.split(" ");
                DefaultTableModel model = (DefaultTableModel) deliverystaffTable.getModel();
                if (model.getRowCount() >= ds) {
                    model.removeRow(0);
                }
                model.addRow(array);

            }
            deliverystaffTable.setAutoCreateRowSorter(true);
            TableRowSorter<TableModel> sorter = new TableRowSorter<>(deliverystaffTable.getModel());
            deliverystaffTable.setRowSorter(sorter);
    ...
    private void deliverystaffTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deliverystaffTableMouseClicked

    }//GEN-LAST:event_deliverystaffTableMouseClicked
